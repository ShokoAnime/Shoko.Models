...
namespace Shoko.Models.Client
{
    public class CL_AniDB_AnimeCrossRefs
    {
        ...
        // TvDB
        public List<CrossRef_AniDB> CrossRef_AniDB_TvDB { get; set; }
        ...
        // Trakt
        public List<CrossRef_AniDB> CrossRef_AniDB_Trakt { get; set; }
        public List<CL_Trakt_Show> TraktShows { get; set; }

        // MovieDB
        public CrossRef_AniDB CrossRef_AniDB_MovieDB { get; set; }
        ...
        // MAL
        public List<CrossRef_AniDB> CrossRef_AniDB_MAL { get; set; }
