...
public class CL_AnimeGroup_User
{
    ...
    public HashSet<string> Stat_AllTags { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<int> Stat_AllYears { get; set; } = new();

    public SortedSet<string> Stat_AllSeasons { get; set; } = new(new SeasonComparator());

    public HashSet<string> Stat_AllCustomTags { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<string> Stat_AllTitles { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<string> Stat_AnimeTypes { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);
    ...
    public HashSet<string> Stat_AllVideoQuality { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<string> Stat_AllVideoQuality_Episodes { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<string> Stat_AudioLanguages { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);

    public HashSet<string> Stat_SubtitleLanguages { get; set; } = new(StringComparer.InvariantCultureIgnoreCase);
